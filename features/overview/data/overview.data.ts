...
export const snapshotMetrics = [
  {
    ...
    value: "1,284",
    detail: "Developer jobs in the dataset",
    context: "The base count behind every percentage.",
    icon: Database,
    fill: 82,
  },
  {
    ...
    value: "826",
    detail: "Unique hiring companies",
    context: "Shows how broad the dataset is.",
    icon: Building2,
    fill: 64,
  },
  {
    ...
    context: "Used as the salary comparison baseline.",
    icon: CircleDollarSign,
    fill: 72,
    delta: "+4% vs dataset median",
  },
  {
    label: "Skills tracked",
    value: "242",
    detail: "Recognized technologies and tools",
    context: "Skills grouped across similar terms.",
    icon: Layers3,
    fill: 58,
  },
];
...
export const keySignals = [
  {
    icon: TrendingUp,
    title: "React and AWS lead current technology demand.",
    stat: "18% and 16%",
  },
  {
    icon: Network,
    title: "Software engineering and backend roles make up the largest role share.",
    stat: "33% combined",
  },
  {
    icon: Link2,
    title: "TypeScript often appears together with React.",
    stat: "68% overlap",
  },
];
